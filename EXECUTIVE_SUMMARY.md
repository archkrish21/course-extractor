...
- **Homepage feature config** (`config/homepage-features.ts`): `showTestimonials: true` (three placeholder testimonials — student/parent/counselor personas with star ratings), `showContactPage: false`, `showPricing: false`.
...
- **Tests**: 17 E2E for homepage/about/contact + 5 API for contact endpoint + 6 API for feedback endpoint + 5 E2E for feedback widget + 5 E2E for testimonials + footer link. **Total: 272 tests.**
