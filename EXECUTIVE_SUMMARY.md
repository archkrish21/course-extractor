...
- **Tests**: 13 new API tests for consent/auth-me/accounts + 20+ new E2E tests for consent/settings/legal pages + counselor invite/join tests + linked accounts limit tests + E2E for linked accounts UI. **Total: 261 tests.**
