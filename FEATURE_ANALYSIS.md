...
3 tiers (Pro tier eliminated). Plus absorbs non-AI features; Elite is the premium AI-powered tier. 14-day trial assigns the Plus plan with `status = 'trialing'` — restricted Plus-level features (no export/share/compare, max 2 plans, no AI).
