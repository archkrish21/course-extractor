...
| F-PL-15 | Per-semester grade assignment. Projected grade (Est.) for planned/enrolled courses, actual grade for completed courses. Grade dropdown with A+ through F options. | Must |
...
| F-GPA-07 | Pass/fail and Incomplete grades excluded from GPA calculation. | Must |
