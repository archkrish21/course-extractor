...
Six pre-seeded templates, each a recommended 4-year course sequence. Shared design (redesigned in PR #174): World History is taken the summer before Gr 9 (all non-CP tracks); Gr 9 PE = Freshman PE (S1) + Choice P.E. (S2); each one-semester course is taken once; target ~6 academic courses/semester (5 for College Prep). Math by track — College Prep: regular (Geometry → Algebra 2 → Precalculus → Data Science); Pre-Med/Humanities/Business: accelerated AB (Geometry AB/BC → Algebra 2 AB/BC → AP Precalc AB → AP Calc AB); STEM/CS: accelerated BC. All start at Geometry in Gr 9 (assumes Algebra 1 in middle school). STEM & CS also run a CS pathway: Computer Programming 1+2 (Gr 9) → AP CS A → AP CS Principles → CS Algorithms.
1. **College Prep (General)** — all-regular (no AP/accelerated); broad, balanced load
2. **STEM Focus** — accelerated math/science (AP Physics 1, AP Chemistry) + CS pathway
3. **Humanities Focus** — AP English Lang/Lit, AP European & U.S. History, AP Gov, AP Art History
4. **Pre-Med Track** — AP Biology + AP Chemistry, Human Anatomy, Science Research
5. **Computer Science Track** — CS pathway + Mobile App Development and engineering electives
6. **Business/Economics Track** — Intro to Business, Marketing, Entrepreneurship, Accounting, Business Law, Personal Finance
...
> **Recent implementation note (PRs #173, #174):** About-page founder start year corrected to 2023; onboarding graduation-year auto-calc is now academic-year aware (correct class year year-round); footer links Instagram (LinkedIn/Twitter removed); FAQ uses up/down chevrons. Planner/Courses copy: summer slots labelled **"Summer"** (was "Pre-Summer"); the **CP** credit type displays as **"College Prep"**; page titles capitalized (**Course Planner**, **Course Browser**, **Your Progress**); GPA-waiver tag no longer clips next to the wider label. Plan templates redesigned — see "Plan Templates at Launch" above.
