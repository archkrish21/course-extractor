  ...
  return (
    <>
      ...
      <div className="print-container bg-white text-black">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <h2 className="mt-1 text-lg font-semibold">
                {plan.name}{plan.isPrimary && <span className="ml-2 text-sm font-normal text-gray-600">★ Primary</span>}
              </h2>
            </div>
        ...
        {/* Summary bar */}
        <div className="mb-4 flex items-center gap-6 rounded border border-gray-300 bg-gray-100 px-4 py-2 text-sm">
          <span>
        ...
        {/* Footer */}
        <div className="mt-4 border-t border-gray-400 pt-2 text-[10px] text-gray-500">
