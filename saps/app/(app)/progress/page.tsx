      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="no-print flex items-center gap-2">
          {(() => {
            ...
            return (
              <span className="relative group" title={printEnabled ? "Print progress report" : "Upgrade to Plus to print"}>
                <Button size="sm" variant="outline" className="gap-1.5" onClick={() => printEnabled && window.print()} disabled={!printEnabled} aria-label={printEnabled ? "Print progress report" : "Upgrade to Plus to print"}>
