      ...
      <div className="space-y-6">
        ...
        <div className="lg:w-1/3">
          <div className="sticky top-4 space-y-4">
            ...
            {data.honorsStatus && (
              <div className="flex items-center gap-3 rounded-xl border border-amber-400/40 bg-gradient-to-r from-amber-50 to-yellow-50 px-4 py-3 dark:from-amber-950/20 dark:to-yellow-950/20">
                ...
                <div>
                  <p className="font-bold text-amber-700 dark:text-amber-400">{data.honorsStatus.tier}</p>
