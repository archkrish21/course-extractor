        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="no-print flex items-center gap-2">
            {(() => {
              ...
              return (
                <span title={printEnabled ? "Print" : "Upgrade to Plus to print"}>
                  <Button variant="outline" size="sm" onClick={() => printEnabled && window.print()} disabled={!printEnabled} aria-label="Print transcript">
