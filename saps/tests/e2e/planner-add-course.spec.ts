...
// narrow waitForURL regex (missing /consent and /onboarding) that hung every
// test in this spec whenever the seeded student briefly redirected through
// one of those routes after login.
